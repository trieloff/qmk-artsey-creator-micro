...
// flip del and backspace
const uint16_t PROGMEM artsey_del[] = {BASE_2_2,BASE_1_3,COMBO_END};
const uint16_t PROGMEM artsey_del_2[] = {NAV_2_2,NAV_1_3,COMBO_END};
const uint16_t PROGMEM artsey_backspace[] = {BASE_1_3,BASE_2_4,COMBO_END};
const uint16_t PROGMEM artsey_backspace_2[] = {NAV_1_3,NAV_2_4,COMBO_END};
...
switch(combo_index) {
case ARTSEY_H:
if (pressed) {SEND_STRING("j");} // J = H
break;
case ARTSEY_Q:
if (pressed) {SEND_STRING("x");} // X = Q
break;
case ARTSEY_U:
if (pressed) {SEND_STRING("f");}
break;
case ARTSEY_C:
if (pressed) {SEND_STRING("i");}
break;
case ARTSEY_K:
